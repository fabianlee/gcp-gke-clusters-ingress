...
sed -i "s/project_name:.*/project_name: my-gkeproj1-$RAN/" group_vars/all
sed -i "s/project=.*/project=\"my-gkeproj1-$RAN\"/" tf/envs/all.tfvars

echo "======== RESULTS ============"
grep ^project_id global.properties
grep ^project_id group_vars/all
grep ^project_name group_vars/all
